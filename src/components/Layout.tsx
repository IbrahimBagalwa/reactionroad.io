...
const Layout = ({ children }: LayoutProps) => {
  ...
  return (
    <div className="bg-white dark:bg-[#282c35] mx-auto dark:text-[rgba(255,255,255,0.88)] text-[#222] min-h-screen">
      <section className="flex items-center justify-center max-w-xl mx-auto w-full pt-10 relative">
        <div>
          ...
          <footer className="flex dark:text-[rgba(255,255,255,0.78)] font-bold bottom-2 absolute text-[#222]">
